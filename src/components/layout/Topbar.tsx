...
const NAV_ITEMS: SearchItem[] = [
  ...
  { id: "nav-school-portal", label: "Nexa Crew · Próximamente", target: "/admin/school/portal", group: "Navegación" },
  { id: "nav-website", label: "Página web", target: "/admin/website", group: "Navegación" },
  { id: "nav-school-settings", label: "Nexa Crew · Perfil (En desarrollo)", target: "/admin/school/portal", group: "Navegación" },
  { id: "nav-school-analytics", label: "Nexa Crew · Analíticas (En desarrollo)", target: "/admin/school/portal", group: "Navegación" },
  { id: "nav-school-posts", label: "Nexa Crew · Publicaciones (En desarrollo)", target: "/admin/school/portal", group: "Navegación" },
  { id: "nav-school-announcements", label: "Nexa Crew · Anuncios (En desarrollo)", target: "/admin/school/portal", group: "Navegación" },
  { id: "nav-school-gallery", label: "Nexa Crew · Galería (En desarrollo)", target: "/admin/school/portal", group: "Navegación" },
