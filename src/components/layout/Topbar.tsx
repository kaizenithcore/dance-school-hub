...
const NAV_ITEMS: SearchItem[] = [
  ...
  { id: "nav-school-announcements", label: "Escuela · Anuncios", target: "/admin/school/announcements", group: "Navegación" },
  { id: "nav-school-gallery", label: "Escuela · Galería", target: "/admin/school/gallery", group: "Navegación" },
