      ...
      <div className="container">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-foreground mb-1">Web básica</h3>
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-foreground mb-1 mt-1">Web optimizada</h3>
            <p className="text-sm text-muted-foreground mb-5">
              Diseñada para convertir visitas en alumnos. Más matrículas con el mismo tráfico.
            </p>
            <ul className="space-y-2.5">
