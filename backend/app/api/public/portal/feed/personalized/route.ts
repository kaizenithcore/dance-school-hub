...
export async function GET(request: NextRequest) {
  ...
  try {
    const result = await portalFoundationService.listPersonalizedFeed(auth.userId, {
    ...
    const message = error instanceof Error ? error.message : "Failed to fetch personalized feed";
