...
import { schoolProfileSchema } from "@/lib/validators/portalFoundationSchemas";
...
export async function PATCH(request: NextRequest) {
  ...
  try {
    ...
    const data = await portalFoundationService.updateSchoolProfile(auth.context.tenantId, parsed.data);
